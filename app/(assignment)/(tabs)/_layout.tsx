...
export default function AssignmentTabsLayout() {
    ...
    // Tab order: index (About) → submissions → completed → uncompleted
    const tabOrder = ['index', 'submissions', 'completed', 'uncompleted'];
    ...
    const getIconName = (routeName: string): string => {
        const icons: { [key: string]: string } = {
            'index': 'information-circle-outline',
            'submissions': 'document-text-outline',
            'completed': 'checkmark-done-outline',
            'uncompleted': 'close-circle-outline',
        };
